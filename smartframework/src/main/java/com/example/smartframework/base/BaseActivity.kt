...
import com.example.smartframework.widget.EmptyViewHelper
...
abstract class BaseActivity<V : ViewDataBinding, VM : BaseViewModel> : AppCompatActivity(),
  ...
  */
    ...
    private fun <T : ViewModel> createViewModel(activity: FragmentActivity, cls: Class<T>): T {
        return ViewModelProvider(activity, ViewModelFactory.getInstance(application)!!).get(cls)
    }
    ...
    protected fun showNormalLayout(view: View?) {
        ...
        emptyViewHelper?.loadNormalLayout(view)
    }
